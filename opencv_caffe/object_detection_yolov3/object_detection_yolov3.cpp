// object_detection_yolov3.cpp : Defines the entry point for the console application.
//
...
"{ model m     | yolov3.weights | Path to a binary file of model contains trained weights. "
